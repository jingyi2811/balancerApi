...
declare class Gyro2Pool implements PoolBase<Gyro2PoolPairData> {
    ...
    constructor(id: string, address: string, swapFee: string, totalShares: string, tokens: Gyro2PoolToken[], tokensList: string[], sqrtAlpha: string, sqrtBeta: string);
